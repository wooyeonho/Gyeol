...
import { describeProfileEmergence } from "@/lib/relationship-os/engine";
                  ...
                  <>
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-white/52">{emergence.label}</p>
                      </div>
                    ...
                    <div className="mt-4 rounded-2xl border border-cyan-300/15 bg-cyan-400/[0.05] p-4">
                      <p className="text-xs uppercase tracking-[0.18em] text-cyan-100/70">현재 읽어낸 흐름</p>
                      <p className="mt-2 text-sm text-white/85">{emergence.summary}</p>
                      <p className="mt-2 text-xs text-white/55">선호 스타일: {profile.preferredStyle}</p>
                    </div>

                    <div className="mt-4">
                      <p className="text-xs uppercase tracking-[0.18em] text-white/42">관계에서 드러난 단서</p>
