...
export default function WrappedError({ reset }: { error: Error; reset: () => void }) {
  const { t } = useTranslations();
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#0a0a0f] p-6 text-center">
