...
export default function InviteLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-black px-6 py-12 text-white">
        <div className="mx-auto max-w-2xl rounded-[2rem] border border-cyan-300/15 bg-white/[0.06] p-8 text-center shadow-[0_0_90px_rgba(34,211,238,0.12)]">
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-2">
          <div className="rounded-2xl border border-white/12 bg-black/35 p-4 text-left">
          ...
          <div className="rounded-2xl border border-cyan-300/30 bg-cyan-400/[0.14] p-4 text-left">
