...
function buildCsp(nonce: string): string {
  ...
  // Build connect-src whitelist from known service domains
  const connectSources = [
    "'self'",
    supabaseUrl, // Supabase REST + Realtime
    supabaseUrl.replace("https://", "wss://"), // Supabase Realtime WS
    "https://api.groq.com", // Groq AI
    "https://generativelanguage.googleapis.com", // Gemini AI
    "https://api.cloudflare.com", // Cloudflare Workers AI
    "https://api.stripe.com", // Stripe
    "https://js.stripe.com", // Stripe.js
    appUrl, // Self (for webhooks, etc.)
  ].filter(Boolean);
