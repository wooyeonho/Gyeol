...
export function MessageList({
  ...
  firstSessionConfig: { heading: string; helper: string; placeholder: string; prompts: string[] };
  vitality: number;
  locale: "ko" | "en";
  starterPrompts: string[];
  appearance: { palette: { primary: string }; voice: { toneHint: string; accentLabel: string } };
