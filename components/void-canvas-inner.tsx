...
export function VoidCanvasInner({ restoring3dLabel, rareMutation, rarityTier, isMobile, reducedVisualMode, onCanvasReady, ...props }: InnerProps) {
  ...
  return (
    <div ref={wrapperRef} className="relative w-full h-full">
      <Canvas
        ...
        dpr={reducedVisualMode ? [0.5, 1] : isMobile ? [0.75, 1.5] : [1, 2]}
        gl={{
          antialias: true,
