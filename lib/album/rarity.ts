...
const RARITY_MAP: Record<string, RarityMeta> = {
  first_chat: {
    tier: "common",
    label: { ko: "일반", en: "Common", ja: "Common", zh: "Common", es: "Common" },
    color: "#94a3b8",
    glow: "rgba(148,163,184,0.15)",
  },
  dream: {
    tier: "uncommon",
    label: { ko: "비범", en: "Uncommon", ja: "Uncommon", zh: "Uncommon", es: "Uncommon" },
    color: "#22c55e",
  ...
  evolution: {
    tier: "rare",
    label: { ko: "희귀", en: "Rare", ja: "Rare", zh: "Rare", es: "Rare" },
    color: "#3b82f6",
  ...
  personality_evolution: {
    tier: "epic",
    label: { ko: "에픽", en: "Epic", ja: "Epic", zh: "Epic", es: "Epic" },
    color: "#a855f7",
  ...
  species_emergence: {
    tier: "legendary",
    label: { ko: "전설", en: "Legendary", ja: "Legendary", zh: "Legendary", es: "Legendary" },
    color: "#f59e0b",
